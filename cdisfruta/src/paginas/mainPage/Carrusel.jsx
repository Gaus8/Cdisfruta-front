...
const productos = [
  {
    ...
    desc: 'Nuestras aromáticas cruzando fronteras. Sabor colombiano llegando hasta Melbourne.',
  ...
  },
  {
    ...
    desc: 'Un snack saludable y práctico, 100% natural. Tradición y sabor de Ubaté en cada bocado.',
    tag: 'Snack 100% Natural',
  },
  {
    img: '/img/cdisfruta_03.jpg',
    eyebrow: 'Nuestra tierra',
    titulo: 'Tradición de Ubaté',
    desc: 'Llevamos el alma de nuestra tierra en cada mezcla artesanal de hierbas y frutas selectas.',
