...
const PlayIcon = () => (
  <svg className={tw("play-icon")} viewBox="0 0 24 24" width="48" height="48" fill="currentColor">
...
function Videos() {
  ...
  return (
    <section className={tw("section-videos")} ref={sectionRef}>
      {videoData.map((data, index) => {
        ...
        return (
          ...
          >
            ...
            <div className={tw("card-text-box")}>
              <h3>{data.title}</h3>
            </div>
          </article>
        );
